/* Digi-Osc — the Hook page's engine (app.js), trimmed to what a synth page needs. Runs two ways.
...
function postWalk() {
  ...
  parent.postMessage({ hook: "walk", top: w.top + y0, bottom: w.bottom + y0, left: p.left, width: p.width, aspect: 1100 / 908, navH: NAV_H, marginFrac: 0.16, steps, hl }, "*");
}
